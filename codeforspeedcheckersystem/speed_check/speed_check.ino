...
//speed of the vehicle will be calculated using distance formula....
...
void loop()
{
  ...
  if(x==LOW && y==LOW)
  {
    ...
    lcd.setCursor(0,0);
    lcd.print("no vehicle crossing");
    Serial.println("no vehicle crossing");
    delay(10);
  }
  ...
  lcd.setCursor(0,1);
  lcd.print("speed is:");
  Serial.println("Speed of the vehicle crossed is:");
  lcd.print(v);
  Serial.print(v);
  lcd.setCursor(14,1);
  lcd.print("m/s");
